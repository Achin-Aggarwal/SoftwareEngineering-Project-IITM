...
const faceImageIds = [
  0, 10, 11, 12, 14, 17, 19,
  1001, 1005, 1011, 1012, 1015,
  1016, 1021, 1022, 1025, 1027,
  1031, 1032, 1050, 1057, 1062
];
const randomId = faceImageIds[Math.floor(Math.random() * faceImageIds.length)];
const studentProfile = ref(`https://picsum.photos/id/${randomId}/200/200`);
